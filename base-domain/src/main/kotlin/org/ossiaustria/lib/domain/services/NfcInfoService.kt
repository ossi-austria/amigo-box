...
interface NfcInfoService {
    suspend fun getAll(): Resource<List<AmigoNfcInfo>>
    suspend fun findPerRef(ref: String): Resource<AmigoNfcInfo>
    suspend fun findPerId(id: UUID): Resource<AmigoNfcInfo>
}
...
class NfcInfoServiceImpl(
    ...
    override suspend fun findPerRef(ref: String): Resource<AmigoNfcInfo> {
    ...
    override suspend fun findPerId(id: UUID): Resource<AmigoNfcInfo> =
        nfcInfoRepository.getNfcTag(id, true).debounce(1000L).last()

    override suspend fun getAll(): Resource<List<AmigoNfcInfo>> =
